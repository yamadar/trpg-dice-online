...
export const en: Dict = {
  ...
  'tabletop.library.help': 'How saving & loading works',
  ...
  'tabletop.library.overwrite': 'Overwrite',
  'tabletop.library.confirmOverwrite': 'Overwrite "{name}" with the current table?',
  'tabletop.library.overwritten': 'Overwritten',
  ...
  'tabletop.tools.pingOffscreen': 'Ping from {name}',
