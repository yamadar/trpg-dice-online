...
export const ja: Dict = {
  ...
  'tabletop.tutorial.welcome.body':
    'トークンを動かし、アノテーションを描き、フォグで視界を演出するセッションの共有キャンバスです。デスクトップでもスマホでも快適に操作できます。',
  'tabletop.tutorial.viewport.title': 'マップを動かす・拡大する',
  'tabletop.tutorial.viewport.body':
    '何もない場所をドラッグで視点移動。マウスホイールか 2 本指ピンチで拡大／縮小（25〜400%）。自分の視点だけが動き、他の参加者には影響しません。',
  'tabletop.tutorial.tools.title': '左の道具パレット',
  'tabletop.tutorial.tools.body':
    '選択 / ペン / テキスト / 消しゴム。ペンとテキストは色や太さを変更できます。「フォグブラシ」は GM 限定で、セル単位に視界を隠したり開いたりできます。',
  'tabletop.tutorial.tokens.title': 'トークン — 移動・タップ・操作',
  'tabletop.tutorial.tokens.body':
    '自分のトークンはドラッグで移動できます。どのトークンもタップするとダイアログが開き、キャラクター情報を確認したり、共有メモを読み書きしたり（自分のトークンは）サイズ変更・削除もできます。GM はすべてのトークンを編集できます。',
  'tabletop.tutorial.rightPanel.title': '右側のパネル',
  'tabletop.tutorial.rightPanel.body':
    'トークンアイコンをタップすると「マップ上のトークン」（クリックでスポットライト）と「追加・準備」（キャラ配置・NPCライブラリ）が表示されます。GM 限定のタブにはマップ＆グリッド、フォグ、テンプレート/セーブのライブラリがあります。',
  ...
  'tabletop.tutorial.help.body':
    '右側パネルの一番下にある「？」ボタンから、このチュートリアルをいつでも再表示できます。',
