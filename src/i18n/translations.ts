...
const ja: Dict = {
  ...
  'history.empty': '保存された履歴はまだありません。',
  'history.entryCount': '{count} 件の記録',
  'history.unnamed': '名称未設定のルーム',
  'history.open': '履歴を開く',
  'history.delete': 'このルームの履歴を削除',
  'history.deleteConfirm': 'このルームの履歴を削除しますか？元に戻せません。',
  'history.deleteAll': 'すべての履歴を削除',
  'history.deleteAllConfirm': '保存されたすべてのルーム履歴を削除しますか？元に戻せません。',
  'history.backToList': '履歴一覧に戻る',
