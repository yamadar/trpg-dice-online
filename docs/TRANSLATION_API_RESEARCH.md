# リアルタイム翻訳 API 調査 / Translation API Research

> 調査日: 2026-05。名前・キャラクター情報・チャットなどの自由入力テキストを
> 日本語 ⇄ English でリアルタイム翻訳するための API 調査。**本書は調査のみ**で、
